...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'angel': //Week 6 - Thorns
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx-pixel';
				GameOverSubstate.loopSoundName = 'gameOver-pixel';
				GameOverSubstate.endSoundName = 'gameOverEnd-pixel';
				GameOverSubstate.characterName = 'mewhen';
	...
	function cacheCountdown()
	{
		...
		introAssets.set('pixel', ['pixelUI/cd3', 'pixelUI/cd2', 'pixelUI/cd1', 'pixelUI/cdgo']);
				...
				switch (swagCounter)
				{
					case 0:
						...
						if (PlayState.isPixelStage)
							countdown3.setGraphicSize(Std.int(countdown3.width * daPixelZoom));

						countdown3.screenCenter();
						countdown3.antialiasing = antialias;
						insert(members.indexOf(notes), countdown3);
						FlxTween.tween(countdown3, {/*y: countdownReady.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
					...
					case 1:	
						...
						if (PlayState.isPixelStage)
							countdown2.setGraphicSize(Std.int(countdown2.width * daPixelZoom));

						countdown2.screenCenter();
						countdown2.antialiasing = antialias;
						insert(members.indexOf(notes), countdown2);
						FlxTween.tween(countdown2, {/*y: countdownSet.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
							ease: FlxEase.cubeInOut,
							onComplete: function(twn:FlxTween)
							{
								remove(countdown2);
					...
					case 2:
						...
						if (PlayState.isPixelStage)
							countdown1.setGraphicSize(Std.int(countdown1.width * daPixelZoom));

						countdown1.screenCenter();
						countdown1.antialiasing = antialias;
						insert(members.indexOf(notes), countdown1);
						FlxTween.tween(countdown1, {/*y: countdownSet.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
							ease: FlxEase.cubeInOut,
							onComplete: function(twn:FlxTween)
							{
								remove(countdown1);
	...
	override public function update(elapsed:Float)
	{
		...
		if(!inCutscene) {
			...
			if(!startingSong && !endingSong && !notallowed && boyfriend.animation.curAnim != null && boyfriend.animation.curAnim.name.startsWith('idle')) {
